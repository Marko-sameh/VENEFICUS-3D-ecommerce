        ...
        <>
            ...
            {isVisible && (
                <>
                    {/* Overlay */}
                    <div
                        className={`fixed inset-0 bg-black/60 backdrop-blur-sm transition-opacity duration-300 z-40 h-[90vh]
                    ...
                    {/* Search Panel */}
                    <div
                        className={`fixed inset-0 z-50 bg-white/95 backdrop-blur-sm transform transition-transform duration-300 h-[90vh]
