...
const DropdownMenu = React.memo(React.forwardRef(({
  ...props
}, ref) => {
...
const DropdownMenuTrigger = React.memo(React.forwardRef(({
  ...
  return (<DropdownMenuPrimitive.Trigger ref={ref} data-slot="dropdown-menu-trigger" type="none" {...props} />);
}));
...
const DropdownMenuContent = React.memo(React.forwardRef(({
  ...
  const contentClassName = React.useMemo(() => cn(
    "bg-[var(--background)] text-[var(--text-primary)] data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2 z-50 max-h-(--radix-dropdown-menu-content-available-height) min-w-[16rem] origin-(--radix-dropdown-menu-content-transform-origin) overflow-x-hidden overflow-y-auto rounded-md  p-1 shadow-md",
    className
  ), [className]);
...
const DropdownMenuItem = React.memo(React.forwardRef(({
  ...
  const itemClassName = React.useMemo(() => cn(
    "py-[0.9rem] px-[1.4rem] hover:bg-[var(--main-color)] hover:text-[var(--text-white)] text-sm relative flex cursor-default items-center gap-2 rounded-sm select-none",
    "border-0 hover:border-0 focus:outline-none", // Prevents any border or outline
